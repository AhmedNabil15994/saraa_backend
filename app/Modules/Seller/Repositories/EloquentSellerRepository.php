...
use App\Http\Requests\SellerValidator as ModelValidator;
use App\Http\Requests\SellerUpdateValidator as ModelUpdateValidator;

class EloquentSellerRepository implements EntityRepositoryInterface {
    ...
    public function dataList($request){
        $source = $this->model->where('role_id',2);
        $input = $request->all();
