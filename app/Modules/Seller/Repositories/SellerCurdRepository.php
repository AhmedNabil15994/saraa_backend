...
class SellerCurdRepository implements DesignInterface
{
    ...
    public function searchData(): array
    {
        return  [
            'name' => [
                ...
                'index' => '1',
                'label' => trans('Seller::seller.form.name'),
            ],
            'mobile' => [
                'type' => 'text',
                'class' => 'form-control datatable-input',
                'index' => '1',
                'label' => trans('Seller::seller.form.mobile'),
            ],
            'email' => [
                'type' => 'email',
                'class' => 'form-control datatable-input',
                'index' => '2',
                'label' => trans('Seller::seller.form.email'),
            ],
        ];
    }
    ...
    public function tableData()
    {
        return [
            ...
            'last_login' => [
                'label' => trans('Seller::seller.form.last_login'),
                'type' => '',
                'className' => '',
                'data-col' => 'last_login',
                'anchor-class' => '',
            ...
            'status' => [
                'label' => trans('Seller::seller.form.status'),
                'type' => '',
                'className' => '',
                'data-col' => 'status',
                'anchor-class' => '',
    ...
    {
        return [
            'title' => trans('Seller::seller.title'),
            ...
            'icon' => ' fas fa-user',
            'sortName' => '',
            'addOne' => trans('Seller::seller.newOne'),
        ];
    }
