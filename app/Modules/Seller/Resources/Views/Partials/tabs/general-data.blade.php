...
<div class="form-group p-0 m-0 mb-5">
    ...
    <input type="password" class="form-control col-md-8" name="password" placeholder="{{ trans('Seller::seller.form.password') }}" readonly
...
<div class="form-group row p-0 m-0 mb-5">
    <label class="col-form-label">{{trans('Seller::seller.form.image')}}</label>
    <div class="col-12 p-0">
        <div class="image-input image-input-outline" id="kt_image_5" style="background-image: url({{ isset($model) ? $model->image_url : asset(config('modules.site_configs.default_upload_img'))  }})">
            ...
            <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="{{trans('Seller::seller.form.change_image_p')}}">
