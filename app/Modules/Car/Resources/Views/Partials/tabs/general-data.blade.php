...
<div class="form-group  p-0 m-0 mb-5">
    <label class="">{{ trans('Car::car.form.store') }} :</label>
...
<div class="form-group p-0 m-0 mb-5">
    <label class="col-form-label">{{ trans('Dashboard::dashboard.tags') }} :</label>
    <select name="tags[]" multiple class="form-control col-md-8" data-toggle="select2">
        <option value="">{{trans('Dashboard::dashboard.choose')}}</option>
        <option value="is_daily" {{ 1 ==  (isset($model) && $model->is_daily ? $model->is_daily : '') ? 'selected' : '' }}>{{trans('Dashboard::dashboard.is_daily')}}</option>
        <option value="is_monthly" {{ 1 ==  (isset($model) && $model->is_monthly ? $model->is_monthly : '') ? 'selected' : '' }}>{{trans('Dashboard::dashboard.is_monthly')}}</option>
    </select>
</div>
