...
use App\Entities\Year as Model;
use App\Http\Requests\YearValidator as ModelValidator;

class EloquentYearRepository implements EntityRepositoryInterface {
    ...
    public function dataList($request){
        ...
        if(isset($input['title']) && !empty($input['title'])){
            $source = $source->where('title','LIKE','%'.$input['title'].'%');
        }
