...
use App\Http\Requests\SliderValidator as ModelValidator;

class EloquentSliderRepository implements EntityRepositoryInterface {
    ...
    public function create($request) {
        ...
        if($request->hasFile('image')){
            $image = \FilesHelper::uploadFile('sliders',$request->file('image'),$return->id);
    ...
    public function update($request,$id) {
        ...
        if($request->hasFile('image')){
            $updateData['image'] = \FilesHelper::uploadFile('sliders',$request->file('image'),$id);
        }
