...
use App\Http\Requests\ClientValidator as ModelValidator;
use App\Http\Requests\ClientUpdateValidator as ModelUpdateValidator;

class EloquentClientRepository implements EntityRepositoryInterface {
    ...
    public function dataList($request){
        $source = $this->model->where('role_id',3);
        $input = $request->all();
