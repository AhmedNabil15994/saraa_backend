...
use App\Http\Requests\SectionValidator as ModelValidator;

class EloquentSectionRepository implements EntityRepositoryInterface {
    ...
    public function create($request) {
        ...
        if($request->hasFile('image')){
            $image = \FilesHelper::uploadFile('sections',$request->file('image'),$return->id);
    ...
    public function update($request,$id) {
        ...
        if($request->hasFile('image')){
            $updateData['image'] = \FilesHelper::uploadFile('sections',$request->file('image'),$id);
        }
    ...
    public function delete($id) {
        ...
        if ($record->trashed()){
            \FilesHelper::deleteDirectory(public_path('/').'/uploads/sections/'.$id);
