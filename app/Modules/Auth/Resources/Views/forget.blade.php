...
@section('title',trans('Auth::login.forget.title'))
@section('content')
...
<div class="login-form login-signin py-11">
	...
	<form class="form" method="post" action="{{route('auth.password.email')}}">
		...
		<div class="text-center pt-2">
			<button id="kt_login_signin_submit" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3 loginBut">{{trans('Auth::login.forget.reset')}}</button>
		</div>
		<!--end::Action-->
	</form>
	<!--end::Form-->
