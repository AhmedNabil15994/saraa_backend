...
class EmployeeRoleCrudRepository implements DesignInterface
{
    ...
    public function tableData()
    {
        return [
            ...
            'creator' => [
                'label' => trans('EmployeeRole::employeeRole.form.creator'),
                'type' => '',
                'className' => 'edits',
                'data-col' => 'created_by',
                'anchor-class' => 'editable',
    ...
    {
        return [
            'title' => trans('EmployeeRole::employeeRole.title'),
            'url' => 'dashboard/'.'employees-roles',
            'name' => 'employee-roles',
            'nameOne' => 'employee-role',
            'modelName' => 'Role',
            'icon' => ' fas fa-users',
            'sortName' => '',
            'addOne' => trans('EmployeeRole::employeeRole.newOne'),
        ];
    }
