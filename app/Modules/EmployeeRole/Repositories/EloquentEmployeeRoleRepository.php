...
use App\Http\Requests\EmployeeRoleValidator as ModelValidator;

class EloquentEmployeeRoleRepository implements EntityRepositoryInterface {
    ...
    public function create($request) {
        ...
        if(isset($createData['permissions']) && count($createData['permissions']) > 0){
            $createData['permissions'] = serialize($createData['permissions']);
        }
    ...
    public function update($request,$id) {
        ...
        if(isset($updateData['permissions'])){
            $updateData['permissions'] = serialize($updateData['permissions']);
        }else{
