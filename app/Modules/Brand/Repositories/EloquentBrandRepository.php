...
use App\Entities\Brand as Model;
use App\Http\Requests\BrandValidator as ModelValidator;

class EloquentBrandRepository implements EntityRepositoryInterface {
    ...
    public function create($request) {
        ...
        if($request->hasFile('image')){
            $image = \FilesHelper::uploadFile('brands',$request->file('image'),$return->id);
    ...
    public function upload($request,$id){
        ...
        if($request->hasFile('image')){
            $updateData['image'] = \FilesHelper::uploadFile('brands',$request->file('image'),$id);
        }
        return $record->update($updateData);
    }
}
