    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" >{{trans('Color::color.newOne')}}</h5>
                ...
                <div class="active show" role="tabpanel">
                    <ul class="nav nav-tabs nav-primary nav-tabs-space-lg nav-tabs-bold" role="tablist">
                        ...
                        <li class="nav-item mx-2">
                            <a class="nav-link {{$key == 0 ? 'active' : ''}}" id="color-tab-{{$key+1}}" data-toggle="tab" href="#color-{{$key+1}}">
                    ...
                    <div class="tab-content mt-5" id="ColorTabContent">
                        @foreach($available_locales as $key => $lang)
                        <div class="tab-pane fade {{$key == 0 ? 'active show' : '' }}" id="color-{{$key+1}}" role="tabpanel" aria-labelledby="color-tab-{{$key+1}}">
                    ...
                    <div class="form-group p-0 m-0 mb-5">
                        ...
                        <input type="color" class="form-control" name="color" value="{{ old('color')}}" placeholder="{{ trans('Car::car.form.color') }}">
                    </div>
