...
use App\Entities\Color as Model;
use App\Http\Requests\ColorValidator as ModelValidator;

class EloquentColorRepository implements EntityRepositoryInterface {
