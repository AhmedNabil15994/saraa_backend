...
use App\Entities\CarType as Model;
use App\Http\Requests\CarTypeValidator as ModelValidator;

class EloquentCarTypeRepository implements EntityRepositoryInterface {
